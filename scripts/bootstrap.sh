...
create_adapter_envs() {
  ...
  "$REPO_DIR/.venv-step1x/bin/pip" install --index-url https://download.pytorch.org/whl/cu130 torch torchvision
  ...
  "$REPO_DIR/.venv-nemo/bin/pip" install --index-url https://download.pytorch.org/whl/cu130 torch torchaudio
