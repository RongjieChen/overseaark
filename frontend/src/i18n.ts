...
export const messages = {
  "zh-CN": {
    documentTitle: "DGX Spark一支不下班的本地多模态外贸营销团队",
    appTitle: "DGX Spark一支不下班的本地多模态外贸营销团队",
  ...
  en: {
    ...
    rerun: "Rerun",
    cancel: "Cancel",
    exportAll: "Export all languages",
    exportCurrent: "Export current language",
    ...
    emptyStageArtifacts: "No stage artifacts yet.",
    checking: "Checking",
