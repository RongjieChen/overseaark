...
load_env() {
  if [[ -f "$REPO_DIR/.env" ]]; then
    ...
    local override_names=(
      ...
      OVERSEAARK_VLLM_WHEEL_SHA256 OVERSEAARK_VLLM_ENV_DIR
      OVERSEAARK_VLLM_BIN OVERSEAARK_VLLM_MODEL_DIR
      OVERSEAARK_VLLM_MODEL_REVISION OVERSEAARK_VLLM_SERVED_MODEL
      OVERSEAARK_VLLM_PORT OVERSEAARK_VLLM_STARTUP_TIMEOUT
  ...
  export OVERSEAARK_VLLM_ENV_DIR="${OVERSEAARK_VLLM_ENV_DIR:-$REPO_DIR/.venv-vllm}"
  export OVERSEAARK_VLLM_BIN="${OVERSEAARK_VLLM_BIN:-$OVERSEAARK_VLLM_ENV_DIR/bin/vllm}"
  export OVERSEAARK_VLLM_MODEL_DIR="${OVERSEAARK_VLLM_MODEL_DIR:-$OVERSEAARK_MODELS_DIR/nvidia/qwen3.6-35b-a3b-nvfp4}"
  export OVERSEAARK_VLLM_MODEL_REVISION="${OVERSEAARK_VLLM_MODEL_REVISION:-491c2f1ea524c639598bf8fa787a93fed5a6fbce}"
  ...
  export OVERSEAARK_VLLM_STARTUP_TIMEOUT="${OVERSEAARK_VLLM_STARTUP_TIMEOUT:-1200}"
